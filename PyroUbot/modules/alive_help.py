...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>Userbot @xcxidk</b></blockquote>
"""
...
async def help_callback(client, callback_query):
    ...
    if mod_match:
        ...
        await callback_query.edit_message_text(
            text=text 
            + '\n<blockquote><b>USERBOT PREM BY @kingsuserbotlek_bot</a> </b></blockquote>',
            reply_markup=InlineKeyboardMarkup(button),
